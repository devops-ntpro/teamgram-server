...
import (
	...
	"github.com/devops-ntpro/teamgram-server/app/service/media/internal/core"
...
func (s *Service) MediaUploadPhotoFile(ctx context.Context, request *media.TLMediaUploadPhotoFile) (*mtproto.Photo, error) {
	...
	c.Infof("media.uploadPhotoFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.uploadPhotoFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadProfilePhotoFile(ctx context.Context, request *media.TLMediaUploadProfilePhotoFile) (*mtproto.Photo, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.uploadProfilePhotoFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.uploadProfilePhotoFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetPhoto(ctx context.Context, request *media.TLMediaGetPhoto) (*mtproto.Photo, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getPhoto - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.getPhoto - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetPhotoSizeList(ctx context.Context, request *media.TLMediaGetPhotoSizeList) (*media.PhotoSizeList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getPhotoSizeList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.getPhotoSizeList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetPhotoSizeListList(ctx context.Context, request *media.TLMediaGetPhotoSizeListList) (*media.Vector_PhotoSizeList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getPhotoSizeListList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.getPhotoSizeListList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetVideoSizeList(ctx context.Context, request *media.TLMediaGetVideoSizeList) (*media.VideoSizeList, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getVideoSizeList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.getVideoSizeList - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadedDocumentMedia(ctx context.Context, request *media.TLMediaUploadedDocumentMedia) (*mtproto.MessageMedia, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.uploadedDocumentMedia - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.uploadedDocumentMedia - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetDocument(ctx context.Context, request *media.TLMediaGetDocument) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getDocument - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.getDocument - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetDocumentList(ctx context.Context, request *media.TLMediaGetDocumentList) (*media.Vector_Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getDocumentList - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
...
func (s *Service) MediaUploadEncryptedFile(ctx context.Context, request *media.TLMediaUploadEncryptedFile) (*mtproto.EncryptedFile, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.uploadEncryptedFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.uploadEncryptedFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaGetEncryptedFile(ctx context.Context, request *media.TLMediaGetEncryptedFile) (*mtproto.EncryptedFile, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.getEncryptedFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.getEncryptedFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadWallPaperFile(ctx context.Context, request *media.TLMediaUploadWallPaperFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.uploadWallPaperFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.uploadWallPaperFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadThemeFile(ctx context.Context, request *media.TLMediaUploadThemeFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.uploadThemeFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
	...
	c.Infof("media.uploadThemeFile - reply: %s", r.DebugString())
	return r, err
}
...
func (s *Service) MediaUploadStickerFile(ctx context.Context, request *media.TLMediaUploadStickerFile) (*mtproto.Document, error) {
	c := core.New(ctx, s.svcCtx)
	c.Infof("media.uploadStickerFile - metadata: %s, request: %s", c.MD.DebugString(), request.DebugString())
